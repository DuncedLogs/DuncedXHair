...
The phase rule editor also includes a Current Season encounter ID dropdown. It lists the current encounter first when available, then bosses from Current Season raid instances in the Encounter Journal. Picking a boss fills the rule field as `id:<encounterID>`.
